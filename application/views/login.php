				...
				<div class="card my-5">
					<div class="card-body">
						<div class="text-center">
							<img src="<?= base_url('assets/img/smk.png') ?>" class="img-fluid brand-logo" style="width: 40%;"/>
						</div>
						...
						<form action="<?= base_url('login') ?>" method="POST">
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingInput" name="username" placeholder="Username" value="<?= set_value('username'); ?>"/>
							...
							<div class="d-grid mt-4">
								<button type="submit" class="d-grid mt-4 btn btn-primary">Log In</button>
							</div>
						</form>
